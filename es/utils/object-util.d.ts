 ...
 */
export declare function setPropertyByPath(target: Record<string, any>, path: string, value: any): void;
/**
 * 根據路徑取得屬性
 ...
 */
export declare function getPropertyByPath(target: Record<string, any>, path: string): Record<string, any>;
/**
 * 檢查物件是否擁有某個key
 * @param obj 物件
 * @param prop key
